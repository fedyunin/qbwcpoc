...
/**
 * ReceiveResponseXML bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ReceiveResponseXML implements org.apache.axis2.databinding.ADBBean {
    ...
    public String toString() {
        return "ReceiveResponseXML{" +
                ...
                ", localResponseTracker=" + localResponseTracker +
                ", localHresult='" + localHresult + '\'' +
                ", localHresultTracker=" + localHresultTracker +
                ", localMessage='" + localMessage + '\'' +
                ", localMessageTracker=" + localMessageTracker +
                '}';
    }

    public static final javax.xml.namespace.QName MY_QNAME =
            new javax.xml.namespace.QName("http://developer.intuit.com/", "receiveResponseXML", "ns1");
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    protected String localHresult;

    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localHresultTracker = false;

    public boolean isHresultSpecified() {
        return localHresultTracker;
    }
     ...
     * @param param Hresult
     */
    public void setHresult(String param) {
        localHresultTracker = param != null;

        this.localHresult = param;
    ...
    */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":receiveResponseXML", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "receiveResponseXML",
                        xmlWriter);
            }
        ...
        if (localHresultTracker) {
            namespace = "http://developer.intuit.com/";
            writeStartElement(null, namespace, "hresult", xmlWriter);
            ...
            if (localHresult == null) {
                ...
                xmlWriter.writeCharacters(localHresult);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localHresultTracker) {
            ...
            if (localHresult != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localHresult));
            } else {
                throw new org.apache.axis2.databinding.ADBException("hresult cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ReceiveResponseXML parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            ReceiveResponseXML object = new ReceiveResponseXML();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"receiveResponseXML".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ReceiveResponseXML) ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://developer.intuit.com/", "response")
                        .equals(reader.getName())) {
                    ...
                    object.setResponse(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://developer.intuit.com/", "hresult")
                        .equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "hresult" + "  cannot be null");
                    }


                    String content = reader.getElementText();

                    object.setHresult(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://developer.intuit.com/", "message")
                        .equals(reader.getName())) {
